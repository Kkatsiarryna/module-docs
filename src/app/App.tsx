import { ButtonTemplate, ButtonWithIconTemplate } from "../shared/ui/button/Button";
...
function App() {
  return (
    ...
    >
      ...
      ></ButtonTemplate>
      <ButtonTemplate
        className={styles.decline__button}
        label="Да"
      ></ButtonTemplate>
      ...
      ></ButtonTemplate>
      <ButtonWithIconTemplate
        className={styles.addDocument__button}
        label="Добавить документ"
      ></ButtonWithIconTemplate>
      <ButtonTemplate
        className={styles.deleteDocument__button}
